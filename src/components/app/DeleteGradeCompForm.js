...
import { addGradeComposition, updateGradeComposition } from "../../api/grade/grade.api.js";
import Cookies from "universal-cookie";

function DeleteGradeCompForm({ onClose, onClick, _gradeStructureId }) {
    ...
    const gradeId = _gradeStructureId
    useEffect(() => {
        if (!user) {
            navigate("/signin");
        }
            ...
            <div className="w-[600px] bg-white rounded-lg p-8 max-w-[1100px]">
                <div className="relative flex justify-between items-center">
                    <div className="flex justify-between items-center mb-4 w-full">
                        <span className="text-2xl text-[#5f27cd]  font-bold">Edit</span>
                    </div>
                ...
                <div className="relative overflow-y-auto w-full h-64 font-sans">
                    <div className="flex flex-col">
                        <div className="mt-5">
                            <p className="text-[#5f27cd] font-semibold mb-1">
                        ...
                        <button
                            className="absolute bottom-[0px] w-full bg-[#5f27cd] text-white py-2 px-3 rounded-lg hover:opacity-90"
                            type="submit"
...
export default DeleteGradeCompForm;
