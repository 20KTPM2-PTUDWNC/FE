                                ...
                                <div>
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-white font-semibold rounded-lg text-sm px-5 py-2.5 text-center  ${!agree
                                            ? "bg-gray-400"
                                            : "bg-[#ff4757] hover:opacity-90 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                            }`}
                                    ...
                                    <p className="text-sm font-light text-white dark:text-gray-400">
                                        ...
                                        <Link
                                            to="/signin"
                                            className="font-semibold  text-primary-900 hover:underline dark:text-primary-500"
                                        >
                                            Sign In
                                        </Link>
                                    </p>
